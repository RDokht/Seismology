...
# ============================================================================ #
  export snrFcn
  """
      This function calculates a continuous function of signal-to-noise ratios
      of input signal(s).
...
# ============================================================================ #
  export smooth2d
  """
      This script is written to smooth 2D array using two moving windows.

      dout = smooth2d(din, nrow, ncol, wtype; upsample = false);
    ...
    Inputs:\n
      ...
      wtype ...... type of the averaging window:
        ...
        "exp"     -> exponential window.
    Optional arguments:\n
      upsample ....... if false (default), it will ignore upsampling;
                       otherwise, it has to be an integer (upsampling factor, e.g., 3).

    Output:\n
      dout .......... smoothed output.

  """
  function smooth2d(din, nrow, ncol, wtype; upsample = false)
...
# ============================================================================ #
  export stalta
  """
      This function calculates the STA/LTA function.
...
# ============================================================================ #
  ...
  """
      This script is written to calculate the scaled kurtosis functions.
